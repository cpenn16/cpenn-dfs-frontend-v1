...
const DATA_SOURCES = {
  QB: "/data/nfl/showdown/latest/qb_data.json",
  RB: "/data/nfl/showdown/latest/rb_data.json",
  WR: "/data/nfl/showdown/latest/wr_data.json",
  TE: "/data/nfl/showdown/latest/te_data.json",
  DST: "/data/nfl/showdown/latest/dst_data.json",
};
